...
class Sandbox {
    ...
    runCode(code) {
        return new Promise((resolve, reject) => {
            const id = this.connection.registerCallback(resolve, reject);
            this.connection.callRemoteServiceMethod(id, 'runCode', code);
        });
    }
    ...
    runScript(script) {
        return new Promise((resolve, reject) => {
            const id = this.connection.registerCallback(resolve, reject);
            this.connection.callRemoteServiceMethod(id, 'importScript', script);
        });
    }
}
